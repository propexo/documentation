...
{/* ## Writing Custom Data
You can also write custom data back to the PMS via AccessAPI. Let's say you want to update the resident's favorite color to "red". You can do this by sending a `PUT` request to the `residents` endpoint with the new value in the `custom_data` object.
