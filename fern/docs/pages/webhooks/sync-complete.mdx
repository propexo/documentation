...
If you create new integrations for your users via AccessAPI, this webhook gives you a quick way to be alerted as to when their initial data import has been completed.
...
This may be a great way to know that you can begin querying AccessAPI to get the freshest data related to an integration.
...
This can be handy if you're onboarding your customers and creating their integrations via AccessAPI.
