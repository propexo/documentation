...
**2. Read amenities from AccessAPI with a filter of `name_normalized` with a value of `INTERNET`**
...
**3. Read units from AccessAPI, filtering by `x_property_id` and the Propexo `integration_id`**
